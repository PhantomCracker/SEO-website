      ...
      <div class="container">
        <div class="row pt-5 pb-5">
          <div class="col-lg-12 d-flex align-self-center flex-column mt-3 mt-md-0 pb-4">
            <h1 class="text-white text-start text-center">Local locksmith in  <span class="my-yellow">Northampton</span></h1>
            <ul class="text-center ps-0 pt-2">
              <li class="text-white"><h3><span class="fw-bold">Emergency</span> Locksmith in Northampton</h3></li>
...
export default {
  ...
  metaInfo: {
    title: 'Emergency locksmith in Northampton',
    meta: [
      {
        charset: 'utf-8'
      },
      {
        vmid: 'description',
        name: 'description',
        content: '24/7 emergency locksmith services in Northampton. UK Local Locksmith also provide a range of services and supplies designed to improve the security of your home or business'
      }
    ]
  }
}
