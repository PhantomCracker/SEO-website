      ...
      <div class="container">
        <div class="row pt-5 pb-5">
          <div class="col-lg-12 d-flex align-self-center flex-column mt-3 mt-md-0 pb-4">
            <h1 class="text-white text-start text-center">Local locksmith in  <span class="my-yellow">Leicester</span></h1>
            <ul class="text-center ps-0 pt-2">
              <li class="text-white"><h3><span class="fw-bold">Emergency</span> Locksmith Leicester on spot in 20-30 min</h3></li>
...
<ul class="text-center ps-0 pt-2">
<li>A great way to find a local locksmith near me in Leicester is by using a search engine. </li>
...
<h2>Locksmith Leicester covering areas</h2></br>
<p>We have a local locksmith near your location and he will be on spot in 20-30 minutes. Our locksmiths provide a reliable and professional locksmith service across Leicester and the surrounding areas, including:</p>
<p>Leicester, Bury, Newark, Fleet, Huntingdon, Spalding, St Neots, Stamford, Hampton, Wisbech, Bourne, Oundle, St Ives, Whittlesey, Holbeach, March, Yaxley, Chatteris, Ramsey, Colne, Holywell, Sawtry, Southwick, Walton, Wennington, Ashton, Brampton, Covington, Eastgate, Easton, Ellington, Hartford, Hilton, Houghton, Morton, Newstead, Northborough, Perry, Upton, Wansford, Werrington, Weston, Westwood</p>
<h2>Call Locksmith Leicester 24/7</h2></br>
<p>UKlocallocksmith Locksmiths Leicester is a cheap and experienced locksmith service and we are proud to be known as the “fastest locksmith in Leicester” by anyone that uses our services. You can call us and discuss your problem with us, and we will diagnose the situation, and give you a free quote.</p>
<h2>Emergency Locksmith near me 24/7</h2></br>
<p>UKlocallocksmith locksmiths are available 24 hours a day to help you. We supply & fit all major brands of locks, and can also supply and fit any of the various multi-point locks for uPVC doors or composite doors & also aluminium doors. UKlocallocksmith Locksmiths Leicester can provide the latest snap resistant and burglar proof lock cylinders for any door type and any wooden doors can be upgraded with B/S3621 locks. Have you had a break in? We can do damage repair on your doors and supply and fit new, secure locks.</p>
<h2>Certified Locksmith near me Leicester</h2></br>
...
export default {
  ...
  metaInfo: {
    title: 'Emergency locksmith near me in Leicester',
    meta: [
      {
        charset: 'utf-8'
      },
      {
        vmid: 'description',
        name: 'description',
        content: 'Locksmith near me in Leicester area 24/7. Emergency Locksmith on spot in 20-30 min. best quality locksmith services with multiple teams located near you'
      }
    ]
  }
}
...
.btn-primary {
  background-color: $ourYellow !important;
  border: none;
