      ...
      <div class="container">
        <div class="row pt-5 pb-5">
          <div class="col-lg-12 d-flex align-self-center flex-column mt-3 mt-md-0 pb-4">
            <h1 class="text-white text-start text-center">Local locksmith near me in <span class="my-yellow">Gloucester</span></h1>
...
<div>
<p>UKlocallocksmith Locksmiths Gloucester only provide British, insurance approved locks and locking systems.</p>
<ul class="text-center ps-0 pt-2">
<li>A great way to find a local locksmith near me in Gloucester is by using a search engine. </li>
...
export default {
  ...
  metaInfo: {
    title: 'Emergency locksmith near me in Gloucester',
    meta: [
      {
        charset: 'utf-8'
      },
      {
        vmid: 'description',
        name: 'description',
        content: 'Locksmith near me in Gloucester area 24/7. Emergency Locksmith on spot in 20-30 min. best quality locksmith services with multiple teams located near you.'
      }
    ]
  }
}
