      ...
      <div class="container">
        <div class="navbar-collapse mx-5 px-5 d-flex justify-content-end">
          <ul class="navbar-nav h4">
            ...
            <li class="nav-item">
              <a href="tel:01183100429" class="nav-link phone ps-3 pe-3"><span style="margin-right: 10px"><font-awesome-icon icon="phone-alt"></font-awesome-icon></span>01183100429</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 align-self-center text-center">
              <ul class="contact-list">
                ...
                <li><span><font-awesome-icon icon="phone-alt"></font-awesome-icon></span>Phone: <a href="tel:01183100429">01183100429</a></li>
              </ul>
            </div>
          </div>
          <div class="row pt-3">
...
<!--    End Footer -->
    ...
    <a href="tel:01183100429" class="float-phone d-md-block d-lg-none">
